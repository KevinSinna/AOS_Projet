...
import menage from "../../assets/img/menage.jpg"
import jardin from "../../assets/img/jardin.jpg"
import sav from "../../assets/img/sav.jpg"
import peintre from "../../assets/img/tarif-peintre.jpg"
        ...
        <div class="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-8 lg:items-center">
            <div class="lg:col-start-2 lg:max-w-2xl ml-auto">
                ...
                <p class="mt-4 text-lg leading-6 text-gray-500 dark:text-gray-300">
                    La contruction d'un avenir radieux ensemble main dans la main.
                </p>
            ...
            <div class="mt-10 lg:-mx-4 relative relative-20 lg:mt-0 lg:col-start-1">
                <div class="relative space-y-4">
                    <div class="flex items-end justify-center lg:justify-start space-x-4">
                        <img class="rounded-lg shadow-lg w-32 md:w-56" width="200" src={menage} alt="1"/>
                        <img class="rounded-lg shadow-lg w-40 md:w-64" width="260" src={sav} alt="2"/>
                    </div>
                    <div class="flex items-start justify-center lg:justify-start space-x-4 ml-12">
                        <img class="rounded-lg shadow-lg w-24 md:w-40" width="170" src={peintre} alt="3"/>
                        <img class="rounded-lg shadow-lg w-32 md:w-56" width="200" src={jardin} alt="4"/>
                    </div>
                </div>
            </div>
        </div>
