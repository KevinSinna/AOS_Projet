...
const recentPosts = [
  { id: 1, name: 'ici mettre les profils ', href: '#' },
  { id: 2, name: 'genre axel ici', href: '#' },
  { id: 3, name: 'ou meme soumeth', href: '#' },
]
...
export default function Navbar() {
  return (
    <Popover className="relative bg-white shadow-md rounded-lg ">
      <div className="max-w-7xl max-h-1xl mx-auto px-4 sm:px-6 ">
        <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
                    ...
                    <Popover.Panel className="absolute z-10 left-1/2 transform -translate-x-1/2 mt-3 px-2 w-screen max-w-md sm:px-0">
                      <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                        ...
                        <div className="px-5 py-5 bg-gray-50 sm:px-8 sm:py-8">
                          <div>
                            <h3 className="text-sm tracking-wide font-medium text-gray-500 uppercase">Récents profils </h3>
                          ...
                          <div className="mt-5 text-sm">
                            <a href="#" className="font-medium text-indigo-600 hover:text-indigo-500">
                              {' '}
                              Voir plus de profils <span aria-hidden="true">&rarr;</span>
                            </a>
                          </div>
                        </div>
                      </div>
          ...
          <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
            <a href="./inscription" className="whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-900">
            Rejoignez nous ici !
            </a>
            <a
              href="./connexion"
